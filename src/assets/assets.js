...
import zoho_logo from './zoho_logo.svg'
...
export const jobsData = [
    ...
    },
    {
        ...
        description: `
        <p>A Full-Stack Developer builds both frontend (UI/UX) and backend (server, database) of applications. They use HTML, CSS, JavaScript, React for the frontend and Node.js, Django, MySQL, MongoDB for the backend. They handle APIs, authentication, and deployment, ensuring smooth functionality across the entire system.</p>
        <h2><strong>Key Responsibilities</strong></h2>
        <ol>
    ...
    },
    {
        ...
        description: `
        <p>Digital marketing is the practice of promoting products, services, or brands using online channels such as search engines, social media, email, and websites. It includes strategies like SEO, content marketing, PPC advertising, social media marketing, and email marketing to reach and engage target audiences effectively</p>
        <h2><strong>Key Responsibilities</strong></h2>
        <ol>
            <li>Design and implement network solutions that meet organizational needs.</li>
            <li>Monitor network performance and troubleshoot issues to ensure uptime.</li>
    ...
    }, 
    {
        ...
        description: `
        <p>Software testing is the process of evaluating a software application to identify bugs, errors, or defects and ensure it meets the required quality standards. It includes various testing methods such as manual testing, automation testing, unit testing, integration testing, system testing, and user acceptance testing (UAT)</p>
        <h2><strong>Key Responsibilities</strong></h2>
        <ol>
            <li>Design and implement network solutions that meet organizational needs.</li>
            <li>Monitor network performance and troubleshoot issues to ensure uptime.</li>
