...
const Hero = () => {
  ...
  return (
    <div className='container 2xl:px-20 mx-auto my-10'>
        <div className='bg-gradient-to-r from-violet-800 to-purple-950 text-white py-16 text-center mx-2 rounded-x1'>
        ...
        <div className='border border-gray-300 shadow-md mx-2 mt-5 p-6 rounded-md flex'>
            <div className='flex justify-center gap-10 lg:gap-16 flex-wrap'>
                ...
                <img className='h-10' src={assets.google_logo} alt="" />
                <img className='h-6' src={assets.zoho_logo} alt="" />
                <img className='h-6' src={assets.adobe_logo} alt="" />
                <img className='h-6'src={assets.wipro_logo} />
            </div>
        </div>
